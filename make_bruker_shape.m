function make_bruker_shape(pulsestrucin,calib,outputfile,channel,brukerflag)
...
amp =  abs(pulse(:,1)+1i*pulse(:,2))*100/calib/2/pi;
phase = mod((180/pi)*angle(pulse(:,1) + 1i*pulse(:,2)),360);
